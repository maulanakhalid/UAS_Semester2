public class FarmasiData {
    ...
    public String getI_qtymin() {
        return i_qtymin;
    }

    public void setI_qtymin(String i_qtymin) {
    ...
    public String getI_article() {
        return i_article;
    }

    public void setI_article(String i_article) {
        this.i_article = i_article;
    }

    public String getI_cogs() {
        return i_cogs;
    }

    public void setI_cogs(String i_cogs) {
        this.i_cogs = i_cogs;
    }

    public String getI_kdsell() {
        return i_kdsell;
    }

    public void setI_kdsell(String i_kdsell) {
